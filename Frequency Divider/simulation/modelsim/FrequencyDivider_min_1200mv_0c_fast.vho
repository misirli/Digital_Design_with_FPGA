...
SIGNAL \temporal~0_combout\ : std_logic;
SIGNAL \temporal~q\ : std_logic;
...
\counter[1]~1\ : cycloneiii_lcell_comb
-- Equation(s):
...
\temporal~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \temporal~0_combout\ = \temporal~q\ $ (((counter(2) & (counter(1) & counter(0)))))
